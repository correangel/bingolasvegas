...
$ban=false;
if (@mysql_select_db("bingolasvegas")){
  $ban=true;
} else {
   $ban=false;
}  
...
if($ban==false){
$sql = 'CREATE DATABASE bingolasvegas';
    mysql_query($sql);
    }
    ...
    $filename           = "backup\bingolasvegas.sql.gz";
...
<div class="panel panel-primary" style="border-color: #1f1f1f; border-bottom-color: #1f1f1f;">
  <div class="panel-heading" style="background:#1f1f1f; border-color: #1f1f1f; border-bottom-color: #1f1f1f;">
    <h2 class="panel-title"><span align="right" class="glyphicon glyphicon-floppy-open"></span><b>&nbsp;&nbsp;RESTAURACIÓN DE BASE DE DATOS</b></h2>
  </div>
