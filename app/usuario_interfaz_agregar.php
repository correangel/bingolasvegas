    ...
    <div class="container">
                        ...
                        <form role="form" class="frmusu form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                <input type="text" maxlength="60" class="let form-control" name="nombre" id="nombre" placeholder="" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                <input type="text" maxlength="60" class="form-control" name="login" id="login" placeholder="" />
                            ...
                            <div class="form-group" align="center">
                                <label><a id="usu_agredi" class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Guardar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></label>-<label><a id="usu_vlv_list" class="btn btn-danger">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Volver&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></label>
                            </div>
                            <div class="form-group">
                                &nbsp;
                            </div>
