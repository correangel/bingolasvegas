...
<head>
    ...
    <link href="app/css/sweetalert.css" rel="stylesheet">
    
    <script src="app/js/jquery-3.1.1.min.js"></script>
    <script src="app/js/bootstrap.min.js"></script>
    <script src="app/js/sesion.js"></script>
...
<body style="background-color:#dfaf1f;">
    ...
    <div class="container">
                        ...
                        <form role="form" class="form-horizontal" id="frmlogin">
                            ...
                            <div class="form-group">
                              ...
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="app/img/logo.png" height="100px" />
                            ...
                            <div class="form-group">
                                ...
                                <label for="login" class="col-sm-2 control-label">Login</label>
                                  <div class="col-sm-3">
                                    <input type="text" class="enter form-control" name="login" id="login" placeholder="Ej: mrodriguez" />
                                  </div>
